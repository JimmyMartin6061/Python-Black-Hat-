...
def proxy_handler(client_socket, remote_host,
    ...
    remote_socket = socket.socket(socket.AF_INET, socket.SOCK_STRAEM)
...
def server_loop(local_host, local_port, 
    ...
    try:
        ...
        print("[!!] Check for other listeningsockets or correct permission.")
        sys.exit(0)
    ...
    while True:
        ...
        line = "> Received incoming connection rfom %s:%d" % (addr[0], addr[1])
        print(line)
...
def main():
    ...
    server_loop(local_host, local_port, remote_host, recieve_first)
